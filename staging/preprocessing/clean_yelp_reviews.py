...
restaurant_names = ['Bibibop Asian Grill', 'Native Foods Cafe', 'Ceres Cafe', 'Plymouth Rooftop Bar Grill', 'IDOF I Dream of Falafel', 'Cellars Market', 'Just Salad', 'Exchequer Restaurant Pub', 'Fontanos Subs', 'Potbelly Sandwich Shop', 'Harrys Sandwich Shop', 'Als Beef', 'Muscle Maker Grill', 'Wow Bao', 'The Lounge', 'King Cafe Gourmet Go', 'Jimmys Restaurant', 'Tokyo Lunch Boxes Catering', 'Corner Bakery Cafe', '213 Cafe', 'Burger King', 'QDOBA Mexican Eats', 'Roti Modern Mediterranean', 'Market Creations Cafe', 'Chipotle Mexican Grill', 'Halsted Street Deli', 'Jimmy Johns', 'Freshii']
...
# store full dataset
path = construct_data_path('datasets/yelp/reviews.csv')
