...
def get_decision_tree_rating_prediction(text: str):
...
def get_random_forest_rating_prediction(text: str):
...
def get_logistic_regression_rating_prediction(text: str):
